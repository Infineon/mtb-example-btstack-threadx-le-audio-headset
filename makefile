...
# Enable to set device type to left earbud. Default is headphone.
#CY_APP_DEFINES += -DLEHS_APP_DEVICE_TYPE=APP_DEVICE_TYPE_EAR_BUD_LEFT

# Enable to set device type to right earbud. Default is headphone.
#CY_APP_DEFINES += -DLEHS_APP_DEVICE_TYPE=APP_DEVICE_TYPE_EAR_BUD_RIGHT

# Enable to support multiplexed audio (L + R)
#CY_APP_DEFINES += -DMULTIPLEX_AUDIO_SUPPORTED=1

# Enable this for audio config higher than 48_2_2
#CY_APP_DEFINES += -DMAX_SUPPORTED_OCTETS_PER_CODEC_FRAME=0xA0
